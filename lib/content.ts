  ...
  events: {
    ...
    list: [
      ...
      },
      {
        ...
        description: "Simone Muller and Michaele Kruger have teamed up to give you the tools to empower your Perimenopause journey, focusing on hormones, nutrition, and Hypopressives. This is a 3-part series running 18 September, 16 October, and 20 November, join for one session or all three.\n\n€135 for all 3 sessions if booked by 4 September (early bird). After that, €150 for all 3, or €55 per single session.",
